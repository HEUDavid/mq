...
if __name__ == '__main__':
    ...
    channel.exchange_declare(exchange='python-test2', durable=True, exchange_type='direct')
    # 绑定exchange和队列  exchange 使我们能够确切地指定消息应该到哪个队列去
    channel.queue_bind(exchange='python-test2', queue=result.method.queue, routing_key='OrderId')
